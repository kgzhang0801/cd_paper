...
Within the past decade, many bike-sharing businesses were under continuous and fast-paced expansion~(\cite{shaheen2012public}). This kind of gradual drift in the context can be a good example for testing the capability of detecting ``gradual concept drift" of our method. We apply both retrospective and prospective analysis to detect and understand the origin of concept drift, and thus, in turn develop a better model with those insights. Here, the models we tried are linear regression and MLP, with two hidden layers of $10$ and $5$ nodes, respectively.
