...
\centering
    \begin{subfigure}[t]{0.49\linewidth}
     ...
     \captionsetup{width=.95\linewidth}
     \caption{Retrospective Diagnosis plots for a model trained using raw bike rental counts.}
...
\centering
    \begin{subfigure}[t]{0.49\linewidth}
     ...
     \captionsetup{width=.95\linewidth}
     \caption{Retrospective Diagnosis plots for a model trained using raw bike rental counts. The training data is from $2012$-Jun to $2015$-Jun, and the control limit is set based on training data, but applied on data from the beginning to end of $2017$.}
     \label{fig:bs_raw_cnt}
\end{subfigure}
\caption{
}
...
\centering
    \begin{subfigure}[t]{0.49\linewidth}
     ...
     \captionsetup{width=.95\linewidth}
     \caption{Retrospective Diagnosis plots for a model trained using raw bike rental counts. The training data is from the beginning to end of $2017$, and the control limit is set based on data from $2012$-Jun to $2015$-Jun, but applied on the training data.}
     \label{fig:bs_raw_cnt}
\end{subfigure}
\caption{
}
...
\centering
    \begin{subfigure}[t]{0.49\linewidth}
     ...
     \captionsetup{width=.95\linewidth}
     \caption{Retrospective Diagnosis plots for a model trained using normalized bike rental counts (using yearly mean). The training data is from the beginning to end of $2017$, and the control limit is set based on the training data.}
     \label{fig:bs_raw_cnt}
\end{subfigure}
\caption{
}
