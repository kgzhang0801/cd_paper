...
\centering
 \begin{subfigure}[t]{0.6\linewidth}
         \centering
         \includegraphics[width = 1\linewidth, trim=.35in .6in .35in .6in, clip]{../figures/v14/flow_chart/Retrospective_1.png}
         \caption{Retrospective Analysis.}
         \label{fig:retro_analysis}
  \end{subfigure}
  \begin{subfigure}[t]{0.6\linewidth}
         \centering
         \includegraphics[width = 1\linewidth, trim=.35in .45in .35in .45in, clip]{../figures/v14/flow_chart/Monitoring_1.png}
         \caption{Monitoring.}
         \label{fig:Monitoring}
  \end{subfigure}
  \begin{subfigure}[t]{0.6\linewidth}
         \centering
         \includegraphics[width = 1\linewidth, trim=.35in .45in .35in .45in, clip]{../figures/v14/flow_chart/Diagnose_1.png}
         \caption{Diagnosis.}
         \label{fig:diagnosis}
  \end{subfigure}
