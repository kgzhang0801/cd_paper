...
%  \includegraphics[width = 0.3\linewidth]{../figures/v14/demons_fig/2D_logi_cd.png}
 \begin{subfigure}[t]{0.6\linewidth}
         \centering
	 \includegraphics[width = \textwidth, trim=.2in .2in .6in .45in, clip]{../figures/v14/demons_fig/2D_logi.png}
...
\centering
 \begin{subfigure}[t]{0.49\linewidth}
         \centering
         \includegraphics[width=\textwidth, trim=.2in .2in .6in .45in, clip]{../figures/v14/demons_fig/2D_err_logi.png}
...
%  \end{subfigure}
 \begin{subfigure}[t]{0.49\linewidth}
         \centering
	 \includegraphics[width = \textwidth, trim=.2in .2in .6in .45in, clip]{../figures/v14/demons_fig/2D_score_logi.png}
